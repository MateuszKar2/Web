...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"uuu.js":[function(require,module,exports) {
...
function firstSundayOfMonth(year, month) {
  var firstDay = new Date(year, month - 1, 1); // Month is 0-based in JavaScript
  var dayOfWeek = firstDay.getDay();
  var daysUntilSunday = (7 - dayOfWeek) % 7;
  firstDay.setDate(firstDay.getDate() + daysUntilSunday);
  console.log("First Sunday of ".concat(year, "-").concat(month, ": ").concat(firstDay.toISOString())); // Debugging
  return firstDay;
}
function collectExpensesToFirstSunday(expenses, year, month, firstSunday) {
  var allExpenses = [];
  for (var day in expenses[month]) {
    var dayDate = new Date(year, month - 1, Number(day)); // Convert day string to date
    console.log("Checking day: ".concat(dayDate.toISOString(), ", firstSunday: ").concat(firstSunday.toISOString()));
  ...
  console.log("Collected expenses for ".concat(year, "-").concat(month, ": ").concat(allExpenses)); // Debugging
  return allExpenses;
}
function solution1(expenses) {
  ...
  for (var month in expenses) {
    ...
    var firstSunday = firstSundayOfMonth(year, monthNum); // Get first Sunday of the month
    var allExpenses = collectExpensesToFirstSunday(expenses, year, month, firstSunday);
    console.log("All expenses for ".concat(month, ": ").concat(allExpenses)); // Debugging
...
console.log(solution1(expenses)); // Run the solution function
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","uuu.js"], null)
//# sourceMappingURL=/uuu.420413eb.js.map